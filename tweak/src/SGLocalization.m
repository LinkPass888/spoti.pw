...
static NSDictionary *_translations = nil;

+ (void)initialize {
    if (self == [SGLocalization class]) {
        // Check system language preference
        NSString *preferredLang = NSLocale.preferredLanguages.firstObject ?: @"en";
        _isChinese = [preferredLang hasPrefix:@"zh"];
...
+ (NSString *)localizedStringForKey:(NSString *)key {
    ...
    NSString *translated = _translations[key];
